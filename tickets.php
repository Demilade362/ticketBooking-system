...
<section class="fixed-bottom bg-primary shadow-sm mt-5 d-lg-none">
    <ul class="nav d-flex justify-content-between p-3">
        ...
        <li class="nav-item">
            <a href="Report.php" class="nav-link text-center mx-auto text-light">
        ...
        <li class="nav-item">
            <a href="tickets.php" class="text-center nav-link mx-auto btn btn-light"><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-ticket-perforated-fill" viewBox="0 0 16 16">
