...
<div class="container-extra bg-white shadow-sm mt-5 p-3" style="margin-bottom: 10rem;">
    <?php if ($error['email']) : ?>
...
<section class="fixed-bottom bg-primary shadow-sm mt-5 d-lg-none">
    <ul class="nav d-flex justify-content-between p-3">
        <li class="nav-item">
            <a href="home.php" class="nav-link btn btn-light text-center mx-auto"><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-house-fill" viewBox="0 0 16 16">
        ...
        <li class="nav-item">
            <a href="Report.php" class="nav-link mx-auto text-light text-center">
        ...
        <li class="nav-item">
            <a href="tickets.php" class="nav-link mx-auto text-light text-center"><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-ticket-perforated-fill" viewBox="0 0 16 16">
